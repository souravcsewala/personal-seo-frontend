    ...
    <main className={`flex-1 p-6 transition-all duration-300 ease-in-out ${
     ...
     <div className="max-w-4xl mx-auto">
      <div className="mb-8 fade-in">
       ...
       <p className="text-lg text-gray-600">Share your SEO knowledge and insights with the community.</p>
      </div>
       ...
       <div className="space-y-6">
        ...
        <div>
         ...
         <input
          ...
          className="w-full px-4 py-3 border-2 border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#C96442] focus:border-transparent text-lg bg-gray-50 focus:bg-white transition-all duration-200"
          required
         />
        </div>
        ...
        <div>
         ...
         <div className="border-2 border-dashed border-gray-300 p-8 text-center bg-gray-50 hover:border-[#C96442] transition-colors">
          {formData.featuredImage ? (
           <div className="space-y-4">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
             <input
              ...
              className="w-full max-w-md px-4 py-2 border-2 border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#C96442] focus:border-transparent bg-white transition-all duration-200"
             />
             <button
              type="button"
              onClick={() => setFormData(prev => ({ ...prev, featuredImage: '', imageAlt: '' }))}
              className="text-red-600 hover:text-red-700 px-4 py-2 hover:bg-red-50 transition-all duration-200 font-semibold text-sm"
             >
              Remove Image
             </button>
            </div>
           ...
           <div>
            ...
            <p className="text-gray-600 mb-4 font-medium">Upload a featured image</p>
            <input
             type="file"
             id="featuredImage"
             accept="image/*"
            ...
            <label
             ...
             className="inline-block bg-gradient-to-r from-[#C96442] to-[#B85538] text-white px-6 py-2.5 hover:from-[#B85538] hover:to-[#A54F35] transition-all duration-200 shadow-md hover:shadow-lg cursor-pointer font-semibold"
            >
             Choose Image
            </label>
           </div>
        ...
        {/* Blog Guidelines */}
        <div className="bg-gradient-to-br from-orange-50 to-amber-50 border-2 border-orange-200 p-6">
         <h4 className="font-bold text-orange-900 mb-3 text-lg">Publishing Guidelines</h4>
        ...
        <div className="flex justify-end space-x-4 pt-6 border-t-2 border-gray-100">
         ...
         <button
          type="submit"
          disabled={submitting}
          className={`px-8 py-3 text-white transition-all duration-200 cursor-pointer font-semibold shadow-md hover:shadow-lg ${
           submitting 
            ? 'bg-[#C96442]/60' 
            : 'bg-gradient-to-r from-[#C96442] to-[#B85538] hover:from-[#B85538] hover:to-[#A54F35]'
          }`}
         >
        ...
        {submitError && (
         <div className="mt-4 p-4 bg-red-50 border-2 border-red-200 text-sm text-red-700 font-medium">
          {submitError}
         </div>
        )}
       </div>
