                    ...
                    {formData.options.map((option, index) => (
                      <div key={index} className="flex items-center space-x-3">
                        ...
                        <input
                          ...
                          className="flex-1 px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#C96442] focus:border-transparent"
                          required={index < 2}
                        />
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center">
                      <input
                        ...
                        onChange={handleInputChange}
                        className="rounded border-gray-300 text-[#C96442] focus:ring-[#C96442]"
                      />
