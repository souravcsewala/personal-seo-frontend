   ...
   <div className="flex">
    ...
    <main className={`flex-1 p-6 px-2 transition-all duration-300 ease-in-out ${
     ...
     <div className="max-w-5xl mx-auto">
      ...
      <button
       onClick={() => router.back()}
       className="flex items-center space-x-2 text-gray-600 hover:text-[#C96442] mb-6 transition-colors group"
      >
      ...
      {/* Blog Header */}
      <article className="bg-white rounded-2xl shadow-xl border border-gray-200 p-8 md:p-10 mb-8 fade-in">
       <div className="flex items-center justify-between mb-8">
        <div className="flex items-center space-x-4">
         {blog.author.avatar ? (
          <img
           ...
           className="w-14 h-14 border-2 border-gray-200 shadow-sm object-cover"
          />
         ) : (
        ...
        <div className="flex items-center space-x-3">
         ...
         {blog.category && (
          <span className="inline-flex items-center px-4 py-1.5 text-sm font-semibold bg-gradient-to-r from-[#C96442]/10 to-[#C96442]/5 text-[#C96442] border border-[#C96442]/20">
           {blog.category}
          </span>
         )}
         {(() => {
          ...
          return (
           <div className="flex items-center space-x-3">
            ...
            >
             ...
             <span>{blogEdit.deleting ? 'Deleting...' : 'Delete'}</span>
            </button>
           </div>
          );
         })()}
       ...
       <div className="prose prose-lg max-w-none prose-headings:font-bold prose-p:text-gray-700 prose-a:text-[#C96442] prose-a:no-underline hover:prose-a:underline">
        {blog.description && !blogEdit.editing && (
         <p className="text-lg text-gray-600 mb-8 leading-relaxed font-medium">{blog.description}</p>
        )}
        {blogEdit.editing ? (
       ...
       {/* Engagement Stats */}
       <div className="flex items-center space-x-6 text-gray-600 mt-10 pt-8 border-t-2 border-gray-100">
        <button 
         onClick={handleToggleLike}
         className={`flex items-center space-x-2 px-4 py-2 transition-all duration-200 cursor-pointer ${
          blog.isLiked 
        ...
        <button onClick={handleShare} className="flex items-center space-x-2 px-4 py-2 hover:text-[#C96442] hover:bg-gray-50 transition-all duration-200 cursor-pointer">
         ...
         <span className="font-semibold">{blog.shares}</span>
        </button>
        <button onClick={handleToggleSave} className={`px-4 py-2 transition-all duration-200 cursor-pointer ${
         isSaved 
          ? 'text-[#C96442] bg-[#C96442]/10' 
          : 'text-gray-600 hover:text-[#C96442] hover:bg-gray-50'
        }`}>
         <svg className="w-6 h-6" fill={isSaved ? '#C96442' : 'none'} stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="bg-white rounded-2xl shadow-md border border-gray-200 p-8 md:p-10 mb-8">
       ...
       <form onSubmit={handleAddComment} className="mb-10">
        <div className="flex space-x-4">
         <div className="w-12 h-12 bg-gradient-to-br from-[#C96442] to-[#A54F35] flex items-center justify-center text-white font-bold text-lg flex-shrink-0">
         ...
         <div className="flex-1">
          <textarea
           ...
           className="w-full px-4 py-3 border-2 border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#C96442] focus:border-transparent resize-none bg-gray-50 focus:bg-white transition-all duration-200"
           rows={4}
          />
          <div className="flex justify-end mt-3">
           <button
            ...
            className="bg-gradient-to-r from-[#C96442] to-[#B85538] text-white px-6 py-2.5 hover:from-[#B85538] hover:to-[#A54F35] transition-all duration-200 shadow-md hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed font-semibold"
           >
            Post Comment
           </button>
          </div>
             ...
             <div className="space-y-3">
              ...
              {(() => {
               ...
               return items.map((rep, rIdx) => (
                <div key={(rep._id || rIdx)} className={`ml-6 border border-gray-200 p-3 ${rep.parentId ? 'bg-gray-50 border-l-4 border-gray-200' : 'bg-gray-50'}`}>
      ...
      <div className="bg-white shadow-sm border border-gray-200 p-8">
       ...
       <div className="space-y-6">
         ...
         <div key={post._id} className="flex space-x-4 cursor-pointer hover:bg-gray-50 p-4 transition-colors" onClick={() => router.push(`/blog/${encodeURIComponent(post.slug || post._id)}`)}>
