     ...
     <div className="max-w-4xl mx-auto">
      ...
      <div className="space-y-4">
       {loading && items.length === 0 ? (
        ...
        <>
         {items.map((a) => (
          <article key={a._id} className="bg-white shadow-sm border border-gray-200 p-5">
           <div className="mb-2">
           ...
           <div className="text-sm text-gray-600 mb-3 flex flex-wrap gap-3 items-center">
            {(() => {
             ...
             return (
              <span className={`inline-flex items-center px-2 py-0.5 ${statusClass}`}>{status}</span>
             );
            })()}
      ...
      {hasMore && (
       <div className="flex justify-center mt-6">
        <button
         onClick={() => load(page + 1)}
         disabled={loading}
         className="px-4 py-2 bg-[#C96442] text-white hover:bg-[#C96442]/90 transition-colors disabled:opacity-60"
        >
