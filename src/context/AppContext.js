...
export function useApp() {
 ...
 // During SSR/build, context might not be available - return default values
 if (!ctx) {
  if (typeof window === 'undefined') {
   // Server-side: return default values to prevent errors during build/prerender
   return {
    user: null,
    sidebarOpen: false,
    theme: 'light',
  ...
  // Client-side: throw error if context is missing
