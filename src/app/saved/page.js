          ...
          <div className="max-w-4xl mx-auto">
            ...
            {loading ? (
              ...
              <div className="space-y-4">
                {items.map((it) => (
                  <div key={it.id} className="flex space-x-4 bg-white border border-gray-200 rounded-lg p-4 hover:bg-gray-50 cursor-pointer" onClick={() => router.push(`/blog/${encodeURIComponent(it.slug || it.id)}`)}>
                    {it.image && (
