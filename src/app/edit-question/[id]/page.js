        ...
        <main className="flex-1 p-6">
          <div className="max-w-4xl mx-auto bg-white border border-gray-200 rounded-lg p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <input id="title" value={form.title} onChange={(e)=>setForm(v=>({...v,title:e.target.value}))} placeholder="Enter your question title" className="w-full border border-gray-300 rounded p-2" />
