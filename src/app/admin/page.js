        ...
        <main className={`flex-1 p-6 transition-all duration-300 ease-in-out ${
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
              {/* Approved Content */}
              <div className="p-6 rounded-xl bg-gradient-to-br from-green-50 to-green-100 border-2 border-green-200 shadow-md hover:shadow-lg transition-all duration-300">
              ...
              {/* Pending Review */}
              <div className="p-6 rounded-xl bg-gradient-to-br from-yellow-50 to-yellow-100 border-2 border-yellow-200 shadow-md hover:shadow-lg transition-all duration-300">
                <div className="flex items-center justify-between mb-3">
                  <div>
              ...
              {/* Declined Content */}
              <div className="p-6 rounded-xl bg-gradient-to-br from-red-50 to-red-100 border-2 border-red-200 shadow-md hover:shadow-lg transition-all duration-300">
                <div className="flex items-center justify-between mb-3">
                  <div>
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-8 shadow-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <Link href="/admin/blog-approval" className="p-4 rounded-xl bg-blue-50 hover:bg-blue-100 border border-blue-200 transition-colors group">
                ...
                {/**
                <Link href="/admin/question-approval" className="p-4 rounded-xl bg-green-50 hover:bg-green-100 border border-green-200 transition-colors group">
                  <div className="flex items-center space-x-3">
                ...
                */}
                ...
                {/**
                <Link href="/admin/poll-approval" className="p-4 rounded-xl bg-purple-50 hover:bg-purple-100 border border-purple-200 transition-colors group">
                  <div className="flex items-center space-x-3">
                ...
                */}
                ...
                <Link href="/admin/users" className="p-4 rounded-xl bg-orange-50 hover:bg-orange-100 border border-orange-200 transition-colors group">
                  <div className="flex items-center space-x-3">
