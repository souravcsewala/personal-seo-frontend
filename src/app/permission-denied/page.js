 ...
 return (
  <div className="min-h-screen flex items-center justify-center bg-gray-50 p-6">
   <div className="max-w-md w-full bg-white border border-gray-200 p-8 text-center">
    <div className="mx-auto mb-4 w-16 h-16 bg-red-100 flex items-center justify-center">
    ...
    <div className="flex items-center justify-center gap-3">
     <button onClick={() => router.push('/')} className="px-4 py-2 bg-[#C96442] text-white hover:bg-[#C96442]/90">Go Home</button>
     <Link href="/login" className="px-4 py-2 border border-gray-300 text-gray-700 hover:bg-gray-50">Login</Link>
    </div>
   </div>
  </div>
 );
