  ...
  <div className="border border-gray-300 overflow-hidden">
   ...
   <div className="bg-gray-50 border-b border-gray-300 p-2 flex flex-wrap items-center gap-1">
    ...
    <div className="flex items-center gap-1 ml-1">
     <ToolbarButton
      onClick={() => setBaseFontSize((s) => Math.max(12, Math.min(32, s - 2)))}
      title="Smaller text"
     >
      <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor">
       <path d="M4 20h4l4-16h-4l-4 16zM14 12h7" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
     </ToolbarButton>
     <span className="text-xs text-gray-600 w-10 text-center">{baseFontSize}px</span>
     <ToolbarButton
      onClick={() => setBaseFontSize((s) => Math.max(12, Math.min(32, s + 2)))}
      title="Larger text"
     >
      <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor">
       <path d="M4 20h4l4-16h-4l-4 16zM14 10h7M14 14h7" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
     </ToolbarButton>
    </div>
    ...
    <select
     ...
     className="px-2 py-1 text-sm border border-gray-300 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-[#C96442]"
    >
