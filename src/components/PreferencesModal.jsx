    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-8 w-full max-w-4xl mx-4 max-h-[90vh] overflow-y-auto">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4 mb-8">
          {categories.map((category) => {
            ...
            return (
              ...
              >
                <div className={`
                  w-20 h-20 rounded-full border-2 overflow-hidden mx-auto mb-2
                  ${category.color}
                ...
                {isSelected && (
                  <div className="absolute -top-1 -right-1 w-6 h-6 bg-[#C96442] rounded-full flex items-center justify-center">
        ...
        <div className="flex justify-between items-center pt-6 border-t border-gray-200">
          ...
          <div className="flex space-x-3">
            ...
            <button
              ...
              className="px-6 py-2 bg-[#C96442] text-white rounded-lg hover:bg-[#C96442]/90 transition-colors font-medium cursor-pointer"
            >
        ...
        {selectedCategories.length > 0 && (
          <div className="mt-4 p-4 bg-[#C96442]/5 rounded-lg">
